    ...
    <>
        <section id='Banner' className='h-screen'>
            <div className="container">
                <div className='pt-15'>
                    <h1 className='text-[#eeeded] font-poppins font-medium text-[29px] Text-Yup'>Get your favorite <span className='text-[#83db50]'>Product</span> from our online store!</h1>
                    ...
                    <div className='flex items-center justify-between mt-10 gap-5'>
                        <span className='bg-[#eeeded] w-22 h-[2px] inline-block'></span>
                        <p className='text-[#eeeded] font-poppins font-normal text-sm'>Or Buy from</p>
                        <span className='bg-[#eeeded] w-22 h-[2px] inline-block'></span>
                    </div>
